    ...
    <footer className="py-12" style={{background: '#0a0a0a'}}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          <div>
            <h3 className="font-heading font-bold text-xl mb-4 text-white">Samanvis Super Speciality Dental Clinic</h3>
            <p className="text-sm text-gray-400">Premium dental care in Hyderabad.</p>
          </div>
          <div>
